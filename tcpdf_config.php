...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	 ...
	 */
	define ('K_PATH_FONTS', K_PATH_MAIN.'assets/fonts/');
	 ...
	 * document creator
	 */
	define ('PDF_CREATOR', 'GS1 Pakistan');

	/**
	 * document author
	 */
	define ('PDF_AUTHOR', 'GS1 Pakistan');

	/**
	 * header title
	 */
	define ('PDF_HEADER_TITLE', 'Company Prefix Application');

	/**
	 * header description string
	 */
	define ('PDF_HEADER_STRING', "GS1 Pakistan");
