    ...
    <div class="panel panel-default">                                
        <div class="form-block hide panel-default">
            ...
            <div class="panel-body">
                <br />
                <form class="form-horizontal" role="form" method="post" id="user-setup-form" action="<?php echo HTTP_SERVER; ?>setup/product_category">
                    <input type="hidden" name="id" id="hdn_id2" />
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="productname">Product Category :</label>
                        <div class="col-sm-4">
