<?php if (isset($flash['errors'])) : ?>
    <div class="col-md-offset-2 col-md-8 alert alert-danger"><a class='close' data-dismiss='alert'>x</a> <i class="glyphicon glyphicon-warning-sign"></i> <?php echo $flash['errors']; ?></div>
<?php endif; ?>
       
<?php if (isset($flash['success'])) : ?>
    <div class="col-md-offset-2 col-md-8 alert alert-success"><a class='close' data-dismiss='alert'>x</a><?php echo $flash['success']; ?></div>
<?php endif; ?>
